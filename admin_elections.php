...
$election = null;
if ($action == 'manage' && $election_id > 0) {
                ...
                <div class="card">
                    ...
                    <form method="POST" action="">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="user_id_<?php echo $position['position_id']; ?>" name="user_id" required>
                        </div>
                        
                        <div class="form-group">
                            <label for="bio_<?php echo $position['position_id']; ?>">Short Bio:</label>
                            <input type="text" id="bio_<?php echo $position['position_id']; ?>" name="short_bio">
                        </div>
                        
                        <div class="form-group">
                            <label for="campaign_<?php echo $position['position_id']; ?>">Campaign Message:</label>
                            <input type="text" id="campaign_<?php echo $position['position_id']; ?>" name="campaign_message">
                        </div>
