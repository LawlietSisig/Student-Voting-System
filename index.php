...
$elections_query = "SELECT * FROM elections WHERE status = 'active' AND NOW() BETWEEN start_date AND end_date ORDER BY start_date";
...
<body>
    ...
    <div class="container">
        ...
        <?php
        $upcoming_query = "SELECT * FROM elections WHERE status = 'upcoming' ORDER BY start_date";
